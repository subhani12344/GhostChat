      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative overflow-hidden border-r border-white/5 bg-gradient-to-br from-neutral-950 to-neutral-900">
        ...
        <div className="space-y-8 max-w-lg relative z-10 my-auto">
          ...
          <div className="grid gap-4">
            {/* Feature 1 */}
            <div className="flex items-center gap-4 bg-white/5 border border-white/10 rounded-2xl p-4 glass-dark hover:border-white/20 transition-all hover:translate-y-[-2px] duration-300">
              ...
              <div>
                <h3 className="font-bold text-sm text-neutral-200">Secure & Anonymous</h3>
                <p className="text-xs text-neutral-400 mt-0.5">Your sessions are fully anonymous with encrypted RTC channels.</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-white/5 border border-white/10 rounded-2xl p-4 glass-dark hover:border-white/20 transition-all hover:translate-y-[-2px] duration-300">
              ...
              <div>
                <h3 className="font-bold text-sm text-neutral-200">Meet People Worldwide</h3>
                <p className="text-xs text-neutral-400 mt-0.5">Filtered matching lets you discover people based on language & interests.</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 bg-white/5 border border-white/10 rounded-2xl p-4 glass-dark hover:border-white/20 transition-all hover:translate-y-[-2px] duration-300">
              ...
              <div>
                <h3 className="font-bold text-sm text-neutral-200">Instant Matching</h3>
                <p className="text-xs text-neutral-400 mt-0.5">Pair immediately in HD video or text rooms. Zero server queue latency.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 sm:p-12 relative z-10">
        ...
        <div className="absolute top-6 right-6 lg:top-8 lg:right-12">
          <button
            ...
            disabled={loading}
            className="px-4 py-2 border border-white/10 hover:border-white/20 hover:bg-white/5 rounded-full text-xs font-bold uppercase tracking-wider transition-all disabled:opacity-40 cursor-pointer"
          >
            Guest Matchmaking
          </button>
        </div>
        ...
        <div className="w-full max-w-md bg-white/5 border border-white/10 rounded-3xl p-8 sm:p-10 glass-dark space-y-6 shadow-2xl relative">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left space-y-2">
            ...
            <h2 className="text-2xl font-black tracking-tight bg-gradient-to-r from-white via-neutral-100 to-neutral-400 bg-clip-text text-transparent">Welcome Back</h2>
            <p className="text-xs text-neutral-400">Unlock custom matches, saved interests, and the follow network.</p>
          </div>

          {/* Form Actions feedbacks */}
          {status === 'success' && (
            <div className="bg-emerald-500/10 border border-emerald-500/35 text-emerald-400 text-xs py-3 px-4 rounded-xl flex items-center space-x-2 animate-in fade-in zoom-in duration-200">
              <CheckCircle className="w-4 h-4 shrink-0" />
              <span>Authentication success! Restoring secure admin session...</span>
            </div>
          )}
          ...
          {showSettings ? (
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl pl-10 pr-4 py-3 text-xs text-white placeholder-neutral-600 focus:outline-none focus:border-rose-500 focus:bg-white/[0.08] transition-all"
                />
              </div>
            </div>
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <Link href="/forgot-password" className="text-[10px] text-rose-400 hover:text-rose-300 font-semibold underline">Forgot Password?</Link>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl pl-10 pr-12 py-3 text-xs text-white placeholder-neutral-600 focus:outline-none focus:border-rose-500 focus:bg-white/[0.08] transition-all"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between pt-1">
              <label className="flex items-center space-x-2 text-xs text-neutral-400 font-semibold cursor-pointer">
                <input
                  type="checkbox"
                  checked={rememberMe}
                  onChange={(e) => setRememberMe(e.target.checked)}
                  className="rounded bg-white/5 border border-white/10 accent-rose-600 w-3.5 h-3.5 focus:ring-0 outline-none"
                />
          ...
          <div className="space-y-4 pt-2 border-t border-white/5">
            <div className="relative flex py-1 items-center">
              ...
              <span className="flex-shrink mx-3 text-[10px] text-neutral-500 uppercase font-black tracking-wider">or sign in with</span>
              <div className="flex-grow border-t border-white/5"></div>
            </div>
